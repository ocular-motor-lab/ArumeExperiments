classdef BeaST_Testing < ArumeExperimentDesigns.EyeTracking
                ...
                elseif strcmp(this.ExperimentOptions.Experiment_Type,'Torsion')
                    ...
                    while secondsRemaining > 0
                        ...
                        if secondsRemaining > 0
                            ...
                            targetLocHPix(1,1) = 0;
                            targetLocVPix(1,1) = 0;
                            for target_i =2:length(r)
                                targetLocHPix(1,1+target_i) = this.Graph.pxWidth/this.ExperimentOptions.DisplayOptions.ScreenWidth * this.ExperimentOptions.DisplayOptions.ScreenDistance * tand(dotsLoc(target_i,1));
                                targetLocVPix(1,1+target_i) = this.Graph.pxWidth/this.ExperimentOptions.DisplayOptions.ScreenWidth * this.ExperimentOptions.DisplayOptions.ScreenDistance * tand(dotsLoc(target_i,2));
