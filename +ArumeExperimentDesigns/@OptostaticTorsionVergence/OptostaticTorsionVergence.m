            ...
            try
                ...
                while secondsRemaining > 0
                    ...
                    if ( secondsElapsed > initialFixationDuration && secondsElapsed < initialFixationDuration + this.ExperimentOptions.TimeStimOn) % then show dots + fixation dot
                        ...
                        Screen('FillRect',this.Graph.window,[130 130 130]);
                    ...
                    elseif ( secondsElapsed < initialFixationDuration )
                        ...
                        Screen('SelectStereoDrawBuffer', this.Graph.window, 0);
                        Screen('FillRect',this.Graph.window,[130 130 130]);
                        Screen('DrawDots', this.Graph.window, [fixXPix_LE; fixYPix_LE], fixSizePix, this.targetColor, [], 1); % fixation spot  %DON'T CHANGE THIS

                        % Draw right stim:
                        Screen('SelectStereoDrawBuffer', this.Graph.window, 1);
                        Screen('FillRect',this.Graph.window,[130 130 130]);
                        Screen('DrawDots', this.Graph.window, [fixXPix_RE; fixYPix_RE], fixSizePix, this.targetColor, [], 1); % fixation spot  %DON'T CHANGE THIS
                    end
